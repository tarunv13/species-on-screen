...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function uo(e,t,n){let r=new Float32Array(Xa),i=new q(0,1,0);return new Si({name:`SphericalGaussianBlur`,defines:{n:Xa,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:mo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function fo(){return new Si({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:mo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function po(){return new Si({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:mo(),fragmentShader:`
	...
	`}var ho=class extends Et{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ri(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Bs={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Vs(e,t){let n=Bs[t];return n===void 0?(U(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Hs=new q;function Us(){return Y.getLuminanceCoefficients(Hs),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Hs.x.toFixed(4)}, ${Hs.y.toFixed(4)}, ${Hs.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},tl=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},nl=new ca(-1,1,1,-1,0,1),rl=new class extends or{constructor(){super(),this.setAttribute(`position`,new Jn([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new Jn([0,2,0,0,2,0],2))}},il=class{constructor(e){this._mesh=new kr(rl,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,nl)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},al=class extends tl{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof Si?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=yi.clone(e.uniforms),this.material=new Si({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new il(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},ol=class extends tl{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},sl=class extends tl{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},cl=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new K);this._width=n.width,this._height=n.height,t=new Et(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:_}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new al(el),this.copyPass.material.blending=0,this.timer=new ga}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}ol!==void 0&&(r instanceof ol?n=!0:r instanceof sl&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new K);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},ll=class extends tl{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new Z}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},ul={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new Z(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};dl.BlurDirectionX=new K(1,0),dl.BlurDirectionY=new K(0,1);function fl(){let e=1e3,t=new Float32Array(e*3),n=new Float32Array(e),r=new Float32Array(e);for(let i=0;i<e;i++)t[i*3]=(Math.random()-.5)*20,t[i*3+1]=(Math.random()-.5)*20,t[i*3+2]=(Math.random()-.5)*20,n[i]=Math.random()*3+1,r[i]=Math.random()*.3+.1;let i=new or;return i.setAttribute(`position`,new Gn(t,3)),i.setAttribute(`aSize`,new Gn(n,1)),i.setAttribute(`aOpacity`,new Gn(r,1)),new ti(i,new Si({uniforms:{time:{value:0},pixelRatio:{value:Math.min(window.devicePixelRatio,2)}},vertexShader:`
    ...
    `,transparent:!0,depthWrite:!1,blending:1}))}var pl=class{constructor(e){this.canvas=e,this.clock=new Pa,this._updateCallbacks=[],this._paused=!1,this._lastTime=performance.now(),this._cameraTarget=new q(0,0,0),this._initScene(),this._initRenderer(),this._initPostProcessing(),this._initParticles(),this._initLighting(),this._initVisibilityHandler(),this._startLoop()}_initScene(){this.scene=new fn,this.scene.background=new Z(657946),this.camera=new sa(60,window.innerWidth/window.innerHeight,.1,100),this.camera.position.set(0,2,20),this.camera.lookAt(this._cameraTarget)}_initRenderer(){this.renderer=new $c({canvas:this.canvas,antialias:!0,alpha:!1}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.toneMapping=4,this.renderer.toneMappingExposure=1}_initPostProcessing(){this.composer=new cl(this.renderer);let e=new ll(this.scene,this.camera);this.composer.addPass(e);let t=new dl(new K(window.innerWidth,window.innerHeight),.3,.4,.85);this.composer.addPass(t)}_initParticles(){this.particles=fl(),this.scene.add(this.particles)}_initLighting(){let e=new da(16777215,.6);this.scene.add(e);let t=new ua(16774630,1.2);t.position.set(5,5,3),this.scene.add(t)}_initVisibilityHandler(){this._visibilityHandler=()=>{document.hidden?(this._paused=!0,this.clock.stop()):(this._paused=!1,this.clock.start(),this._lastTime=performance.now())},document.addEventListener(`visibilitychange`,this._visibilityHandler)}_startLoop(){let e=()=>{if(this._animationId=requestAnimationFrame(e),this._paused)return;let t=this.clock.getElapsedTime(),n=performance.now(),r=(n-this._lastTime)/1e3;this._lastTime=n,this.particles.material.uniforms.time.value=t,this.camera.lookAt(this._cameraTarget);for(let e of this._updateCallbacks)e(r);this.composer.render()};e()}onUpdate(e){this._updateCallbacks.push(e)}flyCamera(t,n,r=1.5,i=`power3.inOut`){let a=e.timeline();return a.to(this.camera.position,{x:t.x,y:t.y,z:t.z,duration:r,ease:i},0),a.to(this._cameraTarget,{x:n.x,y:n.y,z:n.z,duration:r,ease:i},0),a}setCameraPosition(e,t){this.camera.position.set(e.x,e.y,e.z),this._cameraTarget.set(t.x,t.y,t.z),this.camera.lookAt(this._cameraTarget)}resize(){let e=window.innerWidth,t=window.innerHeight;this.camera.aspect=e/t,this.camera.updateProjectionMatrix(),this.renderer.setSize(e,t),this.composer.setSize(e,t),this.particles.material.uniforms.pixelRatio.value=Math.min(window.devicePixelRatio,2)}getScene(){return this.scene}getCamera(){return this.camera}getDomElement(){return this.renderer.domElement}dispose(){this._animationId&&cancelAnimationFrame(this._animationId),document.removeEventListener(`visibilitychange`,this._visibilityHandler),this.renderer.dispose(),this.composer.dispose()}};export{pi as A,ti as C,fi as D,t as E,K as M,q as N,Pe as O,di as S,ja as T,l as _,ii as a,_r as b,ui as c,dn as d,nn as f,s as g,Vr as h,or as i,qi as j,Si as k,ua as l,Nr as m,ao as n,li as o,Yi as p,Gn as r,Z as s,pl as t,Rt as u,X as v,st as w,wi as x,kr as y};