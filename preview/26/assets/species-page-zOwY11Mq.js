...
`).map(e=>`<p>${s(e)}</p>`).join(``):``;d=`
  ...
  `}function E(){let e=document.createElement(`button`);e.className=`sp-back-to-top`,e.setAttribute(`aria-label`,`Back to top`),e.innerHTML=`&#9650;`,document.body.appendChild(e),e.addEventListener(`click`,()=>{window.scrollTo({top:0,behavior:`smooth`})}),window.addEventListener(`scroll`,()=>{window.scrollY>600?e.classList.add(`sp-back-to-top--visible`):e.classList.remove(`sp-back-to-top--visible`)})}function D(e){return e?e.toLowerCase().replace(/[^a-z0-9-]/g,`-`).replace(/-+/g,`-`).replace(/^-|-$/g,``):``}function O(){if(window.matchMedia(`(prefers-reduced-motion: reduce)`).matches){document.body.classList.remove(`sp-loaded`);return}document.querySelectorAll(`.sp-section`).forEach((e,n)=>{if(n===0)return;let r=e.querySelector(`.sp-section__heading`),i=e.querySelectorAll(`.sp-panel, .sp-media-card, .sp-comb__column, .sp-evidence__content, .sp-references__list`);r&&t.fromTo(r,{opacity:0,y:30},{opacity:1,y:0,ease:`back.out(1.7)`,duration:.9,scrollTrigger:{trigger:r,start:`top 85%`}}),i.forEach((e,n)=>{t.fromTo(e,{opacity:0,y:25},{opacity:1,y:0,ease:`back.out(1.4)`,duration:.9,delay:n*.06,scrollTrigger:{trigger:e,start:`top 90%`}})})}),document.querySelectorAll(`.comic-panel`).forEach((e,n)=>{t.fromTo(e,{opacity:0,y:40,scale:.95},{opacity:1,y:0,scale:1,ease:`elastic.out(1, 0.5)`,duration:1,delay:n*.06,scrollTrigger:{trigger:e,start:`top 88%`}})}),document.querySelectorAll(`.sp-fact-card`).forEach((e,n)=>{t.fromTo(e,{opacity:0,y:30},{opacity:1,y:0,ease:`elastic.out(1, 0.75)`,duration:1.2,delay:n*.1,scrollTrigger:{trigger:e,start:`top 90%`}})}),document.querySelectorAll(`.sp-photos__item`).forEach((e,n)=>{t.fromTo(e,{opacity:0,y:40,scale:.95},{opacity:1,y:0,scale:1,ease:`back.out(1.4)`,duration:.8,delay:n*.06,scrollTrigger:{trigger:e,start:`top 90%`}});let r=e.querySelector(`.sp-photos__img`);r&&t.fromTo(r,{yPercent:-5},{yPercent:5,ease:`none`,scrollTrigger:{trigger:e,start:`top bottom`,end:`bottom top`,scrub:!0}})}),k(),document.querySelectorAll(`.sp-cultural-card`).forEach((e,n)=>{t.fromTo(e,{opacity:0,y:30},{opacity:1,y:0,ease:`back.out(1.4)`,duration:.9,delay:n*.08,scrollTrigger:{trigger:e,start:`top 90%`}})}),document.querySelectorAll(`.sp-protected-area-card`).forEach((e,n)=>{t.fromTo(e,{opacity:0,y:25},{opacity:1,y:0,ease:`back.out(1.4)`,duration:.8,delay:n*.05,scrollTrigger:{trigger:e,start:`top 90%`}})}),document.querySelectorAll(`.sp-parallax-divider`).forEach(e=>{t.fromTo(e.querySelector(`.sp-parallax-divider__text`),{opacity:0,y:20},{opacity:1,y:0,ease:`power2.out`,duration:1,scrollTrigger:{trigger:e,start:`top 70%`}})}),e.refresh()}function k(){let e=document.querySelector(`.sp-hero`);e&&t.to(e,{backgroundPositionY:`30%`,ease:`none`,scrollTrigger:{trigger:e,start:`top top`,end:`bottom top`,scrub:!0}}),document.querySelectorAll(`.sp-section__heading`).forEach(e=>{t.fromTo(e,{y:-15},{y:15,ease:`none`,scrollTrigger:{trigger:e,start:`top bottom`,end:`bottom top`,scrub:!0}})}),document.querySelectorAll(`.sp-science__habitat, .sp-evidence__content`).forEach(e=>{t.fromTo(e,{y:20},{y:-20,ease:`none`,scrollTrigger:{trigger:e,start:`top bottom`,end:`bottom top`,scrub:!0}})})}i&&(a(),o());