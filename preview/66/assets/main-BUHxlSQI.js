...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Xa(e,t,n){let r=new Float32Array(Ia),i=new J(0,1,0);return new li({name:`SphericalGaussianBlur`,defines:{n:Ia,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:$a(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Za(){return new li({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:$a(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Qa(){return new li({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:$a(),fragmentShader:`
	...
	`}var eo=class extends Tt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new qr(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
		...
		}`},Zc=class e extends Vc{constructor(e,t=1,n,r){super(),this.strength=t,this.radius=n,this.threshold=r,this.resolution=e===void 0?new q(256,256):new q(e.x,e.y),this.clearColor=new Z(0,0,0),this.needsSwap=!1,this.renderTargetsHorizontal=[],this.renderTargetsVertical=[],this.nMips=5;let i=Math.round(this.resolution.x/2),a=Math.round(this.resolution.y/2);this.renderTargetBright=new Tt(i,a,{type:_}),this.renderTargetBright.texture.name=`UnrealBloomPass.bright`,this.renderTargetBright.texture.generateMipmaps=!1;for(let e=0;e<this.nMips;e++){let t=new Tt(i,a,{type:_});t.texture.name=`UnrealBloomPass.h`+e,t.texture.generateMipmaps=!1,this.renderTargetsHorizontal.push(t);let n=new Tt(i,a,{type:_});n.texture.name=`UnrealBloomPass.v`+e,n.texture.generateMipmaps=!1,this.renderTargetsVertical.push(n),i=Math.round(i/2),a=Math.round(a/2)}let o=Xc;this.highPassUniforms=oi.clone(o.uniforms),this.highPassUniforms.luminosityThreshold.value=r,this.highPassUniforms.smoothWidth.value=.01,this.materialHighPassFilter=new li({uniforms:this.highPassUniforms,vertexShader:o.vertexShader,fragmentShader:o.fragmentShader}),this.separableBlurMaterials=[];let s=[6,10,14,18,22];i=Math.round(this.resolution.x/2),a=Math.round(this.resolution.y/2);for(let e=0;e<this.nMips;e++)this.separableBlurMaterials.push(this._getSeparableBlurMaterial(s[e])),this.separableBlurMaterials[e].uniforms.invSize.value=new q(1/i,1/a),i=Math.round(i/2),a=Math.round(a/2);this.compositeMaterial=this._getCompositeMaterial(this.nMips),this.compositeMaterial.uniforms.blurTexture1.value=this.renderTargetsVertical[0].texture,this.compositeMaterial.uniforms.blurTexture2.value=this.renderTargetsVertical[1].texture,this.compositeMaterial.uniforms.blurTexture3.value=this.renderTargetsVertical[2].texture,this.compositeMaterial.uniforms.blurTexture4.value=this.renderTargetsVertical[3].texture,this.compositeMaterial.uniforms.blurTexture5.value=this.renderTargetsVertical[4].texture,this.compositeMaterial.uniforms.bloomStrength.value=t,this.compositeMaterial.uniforms.bloomRadius.value=.1;let c=[1,.8,.6,.4,.2];this.compositeMaterial.uniforms.bloomFactors.value=c,this.bloomTintColors=[new J(1,1,1),new J(1,1,1),new J(1,1,1),new J(1,1,1),new J(1,1,1)],this.compositeMaterial.uniforms.bloomTintColors.value=this.bloomTintColors,this.copyUniforms=oi.clone(Bc.uniforms),this.blendMaterial=new li({uniforms:this.copyUniforms,vertexShader:Bc.vertexShader,fragmentShader:Bc.fragmentShader,premultipliedAlpha:!0,blending:2,depthTest:!1,depthWrite:!1,transparent:!0}),this._oldClearColor=new Z,this._oldClearAlpha=1,this._basic=new gr,this._fsQuad=new Wc(null)}dispose(){for(let e=0;e<this.renderTargetsHorizontal.length;e++)this.renderTargetsHorizontal[e].dispose();for(let e=0;e<this.renderTargetsVertical.length;e++)this.renderTargetsVertical[e].dispose();this.renderTargetBright.dispose();for(let e=0;e<this.separableBlurMaterials.length;e++)this.separableBlurMaterials[e].dispose();this.compositeMaterial.dispose(),this.blendMaterial.dispose(),this._basic.dispose(),this._fsQuad.dispose()}setSize(e,t){let n=Math.round(e/2),r=Math.round(t/2);this.renderTargetBright.setSize(n,r);for(let e=0;e<this.nMips;e++)this.renderTargetsHorizontal[e].setSize(n,r),this.renderTargetsVertical[e].setSize(n,r),this.separableBlurMaterials[e].uniforms.invSize.value=new q(1/n,1/r),n=Math.round(n/2),r=Math.round(r/2)}render(t,n,r,i,a){t.getClearColor(this._oldClearColor),this._oldClearAlpha=t.getClearAlpha();let o=t.autoClear;t.autoClear=!1,t.setClearColor(this.clearColor,0),a&&t.state.buffers.stencil.setTest(!1),this.renderToScreen&&(this._fsQuad.material=this._basic,this._basic.map=r.texture,t.setRenderTarget(null),t.clear(),this._fsQuad.render(t)),this.highPassUniforms.tDiffuse.value=r.texture,this.highPassUniforms.luminosityThreshold.value=this.threshold,this._fsQuad.material=this.materialHighPassFilter,t.setRenderTarget(this.renderTargetBright),t.clear(),this._fsQuad.render(t);let s=this.renderTargetBright;for(let n=0;n<this.nMips;n++)this._fsQuad.material=this.separableBlurMaterials[n],this.separableBlurMaterials[n].uniforms.colorTexture.value=s.texture,this.separableBlurMaterials[n].uniforms.direction.value=e.BlurDirectionX,t.setRenderTarget(this.renderTargetsHorizontal[n]),t.clear(),this._fsQuad.render(t),this.separableBlurMaterials[n].uniforms.colorTexture.value=this.renderTargetsHorizontal[n].texture,this.separableBlurMaterials[n].uniforms.direction.value=e.BlurDirectionY,t.setRenderTarget(this.renderTargetsVertical[n]),t.clear(),this._fsQuad.render(t),s=this.renderTargetsVertical[n];this._fsQuad.material=this.compositeMaterial,this.compositeMaterial.uniforms.bloomStrength.value=this.strength,this.compositeMaterial.uniforms.bloomRadius.value=this.radius,this.compositeMaterial.uniforms.bloomTintColors.value=this.bloomTintColors,t.setRenderTarget(this.renderTargetsHorizontal[0]),t.clear(),this._fsQuad.render(t),this._fsQuad.material=this.blendMaterial,this.copyUniforms.tDiffuse.value=this.renderTargetsHorizontal[0].texture,a&&t.state.buffers.stencil.setTest(!0),this.renderToScreen?(t.setRenderTarget(null),this._fsQuad.render(t)):(t.setRenderTarget(r),this._fsQuad.render(t)),t.setClearColor(this._oldClearColor,this._oldClearAlpha),t.autoClear=o}_getSeparableBlurMaterial(e){let t=[],n=e/3;for(let r=0;r<e;r++)t.push(.39894*Math.exp(-.5*r*r/(n*n))/n);return new li({defines:{KERNEL_RADIUS:e},uniforms:{colorTexture:{value:null},invSize:{value:new q(.5,.5)},direction:{value:new q(.5,.5)},gaussianCoefficients:{value:t}},vertexShader:`
				...
				}`})}};Zc.BlurDirectionX=new q(1,0),Zc.BlurDirectionY=new q(0,1);function Qc(){let e=1e3,t=new Float32Array(e*3),n=new Float32Array(e),r=new Float32Array(e);for(let i=0;i<e;i++)t[i*3]=(Math.random()-.5)*20,t[i*3+1]=(Math.random()-.5)*20,t[i*3+2]=(Math.random()-.5)*20,n[i]=Math.random()*3+1,r[i]=Math.random()*.3+.1;let i=new ar;return i.setAttribute(`position`,new Wn(t,3)),i.setAttribute(`aSize`,new Wn(n,1)),i.setAttribute(`aOpacity`,new Wn(r,1)),new Gr(i,new li({uniforms:{time:{value:0},pixelRatio:{value:Math.min(window.devicePixelRatio,2)}},vertexShader:`
    ...
    `,transparent:!0,depthWrite:!1,blending:1}))}var $c=class{constructor(e){this.canvas=e,this.clock=new ba,this._updateCallbacks=[],this._paused=!1,this._lastTime=performance.now(),this._cameraTarget=new J(0,0,0),this._initScene(),this._initRenderer(),this._initPostProcessing(),this._initParticles(),this._initLighting(),this._initVisibilityHandler(),this._startLoop()}_initScene(){this.scene=new dn,this.scene.background=new Z(657946),this.camera=new qi(60,window.innerWidth/window.innerHeight,.1,100),this.camera.position.set(0,2,20),this.camera.lookAt(this._cameraTarget)}_initRenderer(){this.renderer=new zc({canvas:this.canvas,antialias:!0,alpha:!1}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.toneMapping=4,this.renderer.toneMappingExposure=1}_initPostProcessing(){this.composer=new Jc(this.renderer);let e=new Yc(this.scene,this.camera);this.composer.addPass(e);let t=new Zc(new q(window.innerWidth,window.innerHeight),.3,.4,.85);this.composer.addPass(t)}_initParticles(){this.particles=Qc(),this.scene.add(this.particles)}_initLighting(){let e=new Zi(16777215,.6);this.scene.add(e);let t=new Xi(16774630,1.2);t.position.set(5,5,3),this.scene.add(t)}_initVisibilityHandler(){this._visibilityHandler=()=>{document.hidden?(this._paused=!0,this.clock.stop()):(this._paused=!1,this.clock.start(),this._lastTime=performance.now())},document.addEventListener(`visibilitychange`,this._visibilityHandler)}_startLoop(){let e=()=>{if(this._animationId=requestAnimationFrame(e),this._paused)return;let t=this.clock.getElapsedTime(),n=performance.now(),r=(n-this._lastTime)/1e3;this._lastTime=n,this.particles.material.uniforms.time.value=t,this.camera.lookAt(this._cameraTarget);for(let e of this._updateCallbacks)e(r);this.composer.render()};e()}onUpdate(e){this._updateCallbacks.push(e)}flyCamera(t,n,r=1.5,i=`power3.inOut`){let a=e.timeline();return a.to(this.camera.position,{x:t.x,y:t.y,z:t.z,duration:r,ease:i},0),a.to(this._cameraTarget,{x:n.x,y:n.y,z:n.z,duration:r,ease:i},0),a}setCameraPosition(e,t){this.camera.position.set(e.x,e.y,e.z),this._cameraTarget.set(t.x,t.y,t.z),this.camera.lookAt(this._cameraTarget)}resize(){let e=window.innerWidth,t=window.innerHeight;this.camera.aspect=e/t,this.camera.updateProjectionMatrix(),this.renderer.setSize(e,t),this.composer.setSize(e,t),this.particles.material.uniforms.pixelRatio.value=Math.min(window.devicePixelRatio,2)}getScene(){return this.scene}getCamera(){return this.camera}getDomElement(){return this.renderer.domElement}dispose(){this._animationId&&cancelAnimationFrame(this._animationId),document.removeEventListener(`visibilitychange`,this._visibilityHandler),this.renderer.dispose(),this.composer.dispose()}},el=[{lat:21.9,lng:89.2,name:`Tiger`,species:`tiger`,ecosystem:`tropical-forest`,color:`#4a7c59`}],tl=[`tiger`];function nl(e,t,n){let r=(90-e)*(Math.PI/180),i=(t+180)*(Math.PI/180);return new J(-(n*Math.sin(r)*Math.cos(i)),n*Math.cos(r),n*Math.sin(r)*Math.sin(i))}var rl=class{constructor(e,t,n){this.scene=e,this.camera=t,this.renderer=n,this.group=new nn,this.scene.add(this.group),this.mediaCounts={},this.columnMeshes=[],this.habitatMeshes=[],this.protectedAreaMeshes=[],this.protectedAreaData=[],this.comingSoonMeshes=[],this.speciesDataCache={},this.activeLayer=`media`,this.raycaster=new _a,this.mouse=new q(-999,-999),this.hoveredIndex=-1,this.isHovered=!1,this._isDragging=!1,this._prevPointer={x:0,y:0},this._velocity={x:0,y:0},this._damping=.95,this._createGlobe(),this._createColumns(),this._createHabitatLayer(),this._createFloraFauna(),this._createComingSoonMarkers(),this._setupInteraction(),this._dataLoadPromise=this._loadMediaCounts()}whenDataLoaded(){return this._dataLoadPromise}_createGlobe(){let e=new ei(1.5,128,128),t=new Pi,n=new di({roughness:.8,metalness:.1});this.sphere=new Or(e,n),this.group.add(this.sphere),t.load(`https://unpkg.com/three-globe/example/img/earth-blue-marble.jpg`,e=>{n.map=e,n.needsUpdate=!0},void 0,()=>{n.color=new Z(4491434),n.needsUpdate=!0});let r=new ei(1.58,64,64),i=new li({vertexShader:`varying vec3 vNormal; void main() { vNormal = normalize(normalMatrix * normal); gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0); }`,fragmentShader:`varying vec3 vNormal; void main() { float intensity = pow(0.6 - dot(vNormal, vec3(0.0, 0.0, 1.0)), 3.0); gl_FragColor = vec4(0.55, 0.50, 0.42, intensity * 0.35); }`,blending:1,side:1,transparent:!0,depthWrite:!1});this.atmosphere=new Or(r,i),this.group.add(this.atmosphere)}_createColumns(){let e=new Qr(.025,24);el.forEach((t,n)=>{let r=nl(t.lat,t.lng,1.502),i=r.clone().normalize(),a=new Z(t.color),o=new gr({color:a.clone(),transparent:!0,opacity:.5,side:2,blending:2,depthWrite:!1}),s=new Or(e.clone(),o);s.position.copy(r),s.lookAt(r.clone().add(i)),s.userData={hotspotIndex:n,species:t.species,name:t.name,restColor:a.clone()},this.group.add(s),this.columnMeshes.push(s)})}_createHabitatLayer(){let e=new Qr(.06,24);el.forEach(t=>{let n=nl(t.lat,t.lng,1.505),r=n.clone().normalize(),i=new gr({color:new Z(t.color),transparent:!0,opacity:.4,side:2,depthWrite:!1}),a=new Or(e.clone(),i);a.position.copy(n),a.lookAt(n.clone().add(r)),a.userData={species:t.species,name:t.name},a.visible=!1,this.group.add(a),this.habitatMeshes.push(a)})}_createProtectedAreaMarkers(e){let t=new ei(.02,12,12),n=new di({color:16739125,emissive:16739125,emissiveIntensity:.6,transparent:!0,opacity:.9});e.forEach(e=>{let r=nl(e.lat,e.lng,1.52),i=new Or(t.clone(),n.clone());i.position.copy(r),i.userData={name:e.name,species:e.species,country:e.country},i.visible=!1,this.group.add(i),this.protectedAreaMeshes.push(i),this.protectedAreaData.push(e)})}setLayer(e){this.activeLayer=e,this.columnMeshes.forEach(e=>{e.visible=!1}),this.habitatMeshes.forEach(e=>{e.visible=!1}),this.protectedAreaMeshes.forEach(e=>{e.visible=!1}),e===`media`||e===`species`?this.columnMeshes.forEach(e=>{e.visible=!0}):e===`habitat`?this.habitatMeshes.forEach(e=>{e.visible=!0}):(e===`protected_areas`||e===`threats`)&&this.protectedAreaMeshes.forEach(e=>{e.visible=!0})}_createFloraFauna(){this.floraFaunaTime=0,this.floraFaunaMeshes=[]}_createComingSoonMarkers(){}_setupDragRotate(){}_setupInteraction(){let e=this.renderer.domElement;this._onMouseMove=e=>{this.mouse.x=e.clientX/window.innerWidth*2-1,this.mouse.y=-(e.clientY/window.innerHeight)*2+1},this._onMouseEnter=()=>{this.isHovered=!0},this._onMouseLeave=()=>{this.isHovered=!1,this.mouse.set(-999,-999)},e.addEventListener(`mousemove`,this._onMouseMove),e.addEventListener(`mouseenter`,this._onMouseEnter),e.addEventListener(`mouseleave`,this._onMouseLeave)}getScreenPositions(e){let t={};el.forEach(e=>{t[e.species]||(t[e.species]=[]),t[e.species].push(e)});let n=[],r=window.innerWidth,i=window.innerHeight;return this.group.updateMatrixWorld(),Object.entries(t).forEach(([t,a])=>{let o=new J;a.forEach(e=>{o.add(nl(e.lat,e.lng,1.5))}),o.divideScalar(a.length);let s=o.clone().applyMatrix4(this.group.matrixWorld),c=new J;e.getWorldDirection(c);let l=s.clone().normalize().dot(c)>-.2,u=s.clone().project(e),d=(u.x*.5+.5)*r,f=(-u.y*.5+.5)*i,p=s.distanceTo(e.position),m=Math.max(.7,Math.min(1.3,5/p));n.push({species:t,screenX:d,screenY:f,scale:m,visible:l,data:this.speciesDataCache[t]})}),n}getSpeciesPosition(e){let t=el.filter(t=>t.species===e);if(t.length===0)return new J;let n=new J;return t.forEach(e=>{n.add(nl(e.lat,e.lng,1.5))}),n.divideScalar(t.length),n}async _loadMediaCounts(){let e=[],t=[],n=[];return(await Promise.allSettled(tl.map(async e=>{let t=await fetch(`/species-on-screen/preview/66/data/${e}.json`);if(!t.ok)throw Error(`HTTP ${t.status}`);return{slug:e,data:await t.json()}}))).forEach((r,i)=>{let a=tl[i];if(r.status===`fulfilled`){let{data:n}=r.value;this.speciesDataCache[a]=n,this.mediaCounts[a]=n.tmdb_media?n.tmdb_media.length:0,n.globe_layers&&n.globe_layers.protected_areas&&n.globe_layers.protected_areas.forEach(t=>{e.push({...t,species:a})}),t.push(a)}else{this.mediaCounts[a]=0;let e=r.reason&&r.reason.message?r.reason.message:String(r.reason);n.push({slug:a,reason:e}),console.warn(`[globe] Species data unavailable: ${a} (${e}). Hotspot retained, card skipped.`)}}),this._updateColumnHeights(),this._createProtectedAreaMarkers(e),{loaded:t,failed:n}}_updateColumnHeights(){}update(){let e=this.isHovered?this.mouse.x*.0018:0;this.group.rotation.y+=3e-4+e}dispose(){let e=this.renderer.domElement;e.removeEventListener(`mousemove`,this._onMouseMove),e.removeEventListener(`mouseenter`,this._onMouseEnter),e.removeEventListener(`mouseleave`,this._onMouseLeave),this.columnMeshes.forEach(e=>{e.geometry.dispose(),e.material.dispose()}),this.habitatMeshes.forEach(e=>{e.geometry.dispose(),e.material.dispose()}),this.protectedAreaMeshes.forEach(e=>{e.geometry.dispose(),e.material.dispose()}),this.comingSoonMeshes.forEach(e=>{e.geometry.dispose(),e.material.dispose()}),this.floraFaunaMeshes.forEach(e=>{e.geometry.dispose(),e.material.dispose()}),this.sphere&&(this.sphere.geometry.dispose(),this.sphere.material.dispose()),this.atmosphere&&(this.atmosphere.geometry.dispose(),this.atmosphere.material.dispose()),this.scene.remove(this.group)}},il=null,al=null,ol=null,sl=!1,cl=null;function ll(){let t=document.getElementById(`cinematic-canvas`);if(!t)return;let n=document.getElementById(`loading-screen`);il=new $c(t),al=new rl(il.getScene(),il.getCamera(),il.renderer),al.setLayer(`species`),window.addEventListener(`resize`,ml),il.onUpdate(e=>{al&&al.update(e)}),n?e.to(n,{opacity:0,duration:1.4,delay:1.5,ease:`power2.inOut`,onComplete:()=>{n.style.display=`none`,pl()}}):pl(),ul()}function ul(){ol=document.getElementById(`page-caption`),ol&&ol.addEventListener(`click`,e=>{e.preventDefault(),dl()})}function dl(){if(sl)return;sl=!0,fl(),al.isHovered=!1,al.group.updateMatrixWorld();let t=al.getSpeciesPosition(`tiger`).clone().applyMatrix4(al.group.matrixWorld),n=t.clone().normalize(),r=t.clone().add(n.clone().multiplyScalar(3)),i=t.clone(),a=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches?.5:1,o=e.timeline();cl=o,o.to(`#page-caption`,{opacity:0,duration:.7*a,ease:`sine.inOut`},0),o.to(`#globe-ui-container`,{opacity:0,duration:.7*a,ease:`sine.inOut`},0),o.add(il.flyCamera(r,i,2*a,`power3.inOut`),.4*a),o.add(()=>{let e=document.getElementById(`loading-screen`);e&&(e.style.display=`block`,e.style.opacity=`0`)},1.9*a),o.to(`#loading-screen`,{opacity:1,duration:1*a,ease:`power2.inOut`},1.9*a),o.to(`#cinematic-canvas`,{opacity:0,duration:.9*a,ease:`power2.inOut`},2*a),o.add(()=>{window.location.assign(`/species-on-screen/preview/66/places/sundarbans.html`)},3*a)}function fl(){cl&&=(cl.kill(),null)}function pl(){let t=document.getElementById(`globe-ui-container`),n=new J(1,.3,5.5),r=new J(0,0,0);il.flyCamera(n,r,6,`power3.inOut`).eventCallback(`onComplete`,()=>{e.delayedCall(.9,()=>{t&&t.classList.add(`active`),ol&&ol.classList.add(`is-visible`)})})}function ml(){il&&il.resize()}document.addEventListener(`DOMContentLoaded`,ll);