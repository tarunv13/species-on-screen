/*
  Field record — research-surface scrollytelling controller (prototype).
  ----------------------------------------------------------------------
  Reads a real Darwin Core Archive at /dwca/sundarbans/ (Occurrence core +
  ResourceRelationship extension) and renders it as a scroll-driven field
  record: a sticky landscape stage carrying the body-system motion
  vocabulary, scroll-stepped sourced text, seasonality, and the
...
function buildSources() {
  ...
  el.innerHTML = `
    ...
    <p class="fr-foot">Sound: a procedural biome bed (low drone, water bed, insect shimmer) generated in the browser; openly-licensed field recordings are credited in
      ...
      ${PLACE === 'sundarbans' ? `This is a research-surface prototype; the attested field note is at <a href="${BASE}notes/sundarbans-bengal-tiger-saline-swimmer.html">notes/</a>.` : 'This is a research-surface prototype.'}</p>
  `;
}
